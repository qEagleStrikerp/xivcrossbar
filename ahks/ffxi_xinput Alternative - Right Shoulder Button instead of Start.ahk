 ...
 *  This alternative version switches Hotbars with Right Shoulder Button instead of Start Button
 */
...
isButtonRightShoulderDown := false
    ...
    Loop, 4 {
        If State := XInput_GetState(A_Index-1) {
            If WinActive("ahk_class FFXiClass") {
                ...
                If (isLeftTriggerDown or isRightTriggerDown or isButtonRightShoulderDown) {
                ...
                If (!isButtonRightShoulderDown and State.wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER) {
                    SendInput {Ctrl down}
                    SendInput {f10 down}

                    isButtonRightShoulderDown := true
                } else If (isButtonRightShoulderDown and !(State.wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER)) {
                    SendInput {f10 up}
                    SendInput {Ctrl up}
